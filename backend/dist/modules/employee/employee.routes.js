...
router.post('/', auth_middleware_1.requireAdmin, controller.createEmployee);
...
router.put('/:id', auth_middleware_1.requireAdmin, controller.updateEmployeeController);
router.delete('/:id', auth_middleware_1.requireAdmin, controller.deleteEmployeeController);
